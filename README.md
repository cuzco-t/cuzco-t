...
Estudiante de Ciencias de la Computación, cursando el útlimo semestre de la carrera, con especialización en Ciencia de Datos e Inteligencia Artificial. Interesado en transformar datos en información valiosa para la toma de decisiones estratégicas.
...
- Se identificó que la cantidad de productos vistos es el principal impulsor de ingresos.
...
- Cada página vista incrementa los odds en un 13%.  
- Cada producto en el carrito eleva los odds en un 48%.  
- Escenarios optimizados muestran que aumentar el tiempo a 33.66 min o las páginas a 17.65 eleva la probabilidad de compra al 80%.  
- Se proponen 3 acciones concretas para marketing y UX, con potencial de recuperar $2.5M mensuales en ventas.

## 📫 Contacto

- **LinkedIn:** [linkedin.com/in/jonnathancuzco](https://www.linkedin.com/in/jonnathan-cuzco/)
- **GitHub:** [github.com/cuzco-t](https://github.com/cuzco-t)

---

*Este README está en constante actualización. Gracias por visitar el perfil.*
